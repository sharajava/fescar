...
public class SelectForUpdateExecutor2<S extends Statement> extends BaseTransactionalExecutor<ResultSet, S> {

    public SelectForUpdateExecutor2(StatementProxy<S> statementProxy, StatementCallback<ResultSet, S> statementCallback, SQLRecognizer sqlRecognizer) {
        ...
        try {
            ...
            while (true) {
                ...
                try {
                    ...
                    statementProxy.getConnectionProxy().acquireLock(selectPKRows);
                    break;
